...
public class HintGeneratorTest {
    ...
    public void testHint_startsWithLetter_yemen() throws Exception {
        ...
        // make sure the first letter of the hint is 'y' (this is a deterministic aspect
        // of the hint generator when the question type is "begin")
    ...
    public void testHint_endsWithLetter_yemen() throws Exception {
        ...
        // make sure the last letter of the hint is 'n' (this is a deterministic aspect
        // of the hint generator when the question type is "end")
